...
function iconFor(item: string, isFolder: boolean): IconMeta {
    ...
    if (["png", "jpg", "jpeg", "gif", "webp", "svg", "bmp", "ico", "heic"].includes(ext))
    ...
    if (["js", "ts", "tsx", "jsx", "py", "rs", "go", "java", "c", "cpp", "rb", "php", "sh", "json", "html", "css", "ipynb", "drawio"].includes(ext))
...
export function File(
    {item, file_event, download_file, view = "grid"}:
    {
        item: string,
            ...
            <li className="group">
                <div className="flex items-center gap-3 rounded-lg px-3 py-2 transition-colors hover:bg-accent">
                    ...
                    >
                        ...
                        <span className="truncate text-sm text-foreground/90">{item}</span>
                    </button>
                    <button
                        onClick={onDownload}
    ...
    return (
        <li className="group relative">
            ...
            >
                ...
                <span className="w-full truncate text-center text-xs text-foreground/90" title={item}>
                    {item}
                </span>
            </button>
            <button
